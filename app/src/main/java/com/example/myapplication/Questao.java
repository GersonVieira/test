...
public class Questao {
    ...
    public Questao(Alternativa alternativa1, Alternativa alternativa2, Alternativa alternativa3, Alternativa alternativa4, Alternativa alternativa5, String dica, String dificuldade, String enunciado, int nivel, int valor,String tema) {
